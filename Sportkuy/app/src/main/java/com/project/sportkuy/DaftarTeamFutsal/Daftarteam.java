...
public class Daftarteam extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView = findViewById(R.id.ImageView);
            ...
            ProductsRef = FirebaseDatabase.getInstance().getReference().child("Futsal");
        ...
        posting.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                stanggal = tanggal.getSelectedItem().toString();
                ValidateProductData();
            }
        });
        waktu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mTimePicker = new TimePickerDialog(Daftarteam.this, new TimePickerDialog.OnTimeSetListener() {
...
//        productRandomKey = saveCurrentDate + saveCurrentTime + "Sportkuy" + currentUser.getDisplayName();
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception e)
            {
                ...
                Toast.makeText(Daftarteam.this, "Error: " + message, Toast.LENGTH_SHORT).show();
                loadingBar.dismiss();
            }
            ...
            {
                Toast.makeText(Daftarteam.this, "Team uploaded Successfully...", Toast.LENGTH_SHORT).show();
                ...
                Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task)
                    {
                        if (task.isSuccessful())
                        {
                            ...
                            Toast.makeText(Daftarteam.this, "gambar team berhasil diupload...", Toast.LENGTH_SHORT).show();
        ...
        ProductsRef.child(productRandomKey).updateChildren(productMap)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task)
                    {
                        if (task.isSuccessful())
                        {
                            Intent intent = new Intent(Daftarteam.this, MainActivity.class);
                            startActivity(intent);

                            loadingBar.dismiss();
                            Toast.makeText(Daftarteam.this, "Team berhasil diupload..", Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            loadingBar.dismiss();
